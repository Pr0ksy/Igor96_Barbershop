...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Barbershop Igor96 - Online Zakazivanje 📲">
		<meta name="author" content="JOVAN PRODANIĆ">
		<title>Barbershop Igor96 - Kovin</title>

		<!-- EXTERNAL CSS LINKS -->
        <link rel="icon" href="Includes/templates/favicon.ico" type="image/x-icon">
